...
/*
    ...
    public static boolean isProInstalled(Activity context){
        return Tools.isPackageInstalled(context, context.getPackageName() + ".noads");
    }

    public static boolean showIntersticial(){
        return IntersticialActivity.showInterstitial();
    }

    public static void ads(Activity activity, AdListener listener) {
        if(!isProInstalled(activity)) {
            if (!Tools.showIntersticial()) {
                Tools.goToNextLevel(activity, listener);
                Tools.showIntersticial();
            }
        }
    }
*/
